...
class IsBookByNameRequest(_message.Message):
    __slots__ = ("book_name",)
...
class GetBookByNameRequest(_message.Message):
    __slots__ = ("book_name",)
    BOOK_NAME_FIELD_NUMBER: _ClassVar[int]
    book_name: str
    def __init__(self, book_name: _Optional[str] = ...) -> None: ...
...
class Book(_message.Message):
    __slots__ = ("title", "author", "genre", "id")
    ...
    genre: str
    id: int
    def __init__(self, title: _Optional[str] = ..., author: _Optional[str] = ..., genre: _Optional[str] = ..., id: _Optional[int] = ...) -> None: ...
